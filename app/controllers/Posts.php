    ...
    public function editar($id){
        ...
        if (isset($formulario)) {
            ...
            if($post->id_usuario != $_SESSION['usuario_id']){
                Sessao::mensagem('post', 'Voce nao tem permissao para editar esse post, idiota!', 'alert alert-danger');
                Url::redirecionar('posts');
            }
            $dados = [
    ...
    public function deletar($id){
        if(!$this->checarAutorizacao($id)){
            ...
            if($id && $metodo == 'POST'){
                ...
                Sessao::mensagem('post', 'Voce nao tem permissao para deletar esse post, idiota!', 'alert alert-danger');
                Url::redirecionar('posts');
            } 
        }else{
            Sessao::mensagem('post', 'Voce nao tem permissao para deletar esse post, idiota!', 'alert alert-danger');
